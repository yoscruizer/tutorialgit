 		...
 		function guessit()
		{
		   ...
		   switch(tries)
		   {
		     ...
		     case 1:
		     document.form1.hint.value = "Clue yang pertama : Nama negaranya berawalan dengan huruf " + temp.charAt(0);
		     break;
		 
		     case 2:
		     document.form1.hint.value = "Clue yang kedua : Nama negaranya berakhiran dengan huruf " + temp.charAt(temp.length - 1);
		     break;
		 
		     case 3:
		     document.form1.hint.value = "Clue yang terakhir : Nama negaranya mempunyai sebanyak " + temp.length + " karakter";
		     break;
		 
		     default:
		     document.form1.hint.value = "Jawaban anda salah!";
		   ...
		   if(guess.toUpperCase() == temp)
		   {
		     ...
		     if(window.confirm("Yupps ! Negaranya adalah " + temp + "\nIngin bermain lagi?"))
		   ...
		   }else
		   {
		    ...
		    if(window.confirm("Salah ! Kesempatan anda habis. Nama negaranya adalah  " + temp + "\nIngin bermain lagi?"))
		    {
		      window.location.reload();
		 
		      document.form1.hint.value = "Klik 'Tebak!' untuk memulai tebakan";
		 ...
		 function newGame()
		 {
		   ...
		   if(window.confirm("Ingin mulai game baru?"))
		   {
